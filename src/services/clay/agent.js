...
- Never open a reply by announcing a build the person didn't ask for. Announce a build only when you have actually decided to build, and say plainly what you're building and why.
