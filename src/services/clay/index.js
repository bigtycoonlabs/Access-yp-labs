...
You must respond with a SINGLE valid JSON object and nothing else, matching:
{
  ...
  "next_steps": string[],              // 2-3 concrete next moves for THIS concept, never generic advice like "do market research". The FIRST must be a real PROOF step a stranger can act on — a customer interview, a landing page, booked calls, a deposit, a preorder, a paid pilot, or repeated use of a rough version — stated with a go-or-kill line: what result would make it worth continuing. Proof is behavior, not compliments; a polished concept with no proof step is not validated.
  "sections": {
