...
The best of what we build lands in the Exchange — a marketplace of businesses proven before anyone dared launch them. Claim one. Sell yours. Snap one onto what you already run. (We trade in ideas, never in running businesses — this is a home for what's possible.)
...
Enter the Exchange: https://accessyplabs.com/dreamhold.html
        ...
        <table role="presentation" width="600" cellpadding="0" cellspacing="0" border="0" style="max-width:600px;width:100%;background-color:#ffffff;border:1px solid #e6e0f5;border-radius:14px;overflow:hidden;">
              ...
              <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                <tr>
                  <td bgcolor="#4c3bd4" style="background-color:#4c3bd4;border-radius:12px;">
                    <a href="https://accessyplabs.com/dreamhold.html" style="display:inline-block;padding:14px 30px;font-family:Arial,Helvetica,sans-serif;font-size:16px;font-weight:bold;color:#ffffff;text-decoration:none;">Enter the Exchange &rarr;</a>
                  </td>
                </tr>
              </table>
          ...
          <tr>
            <td style="padding:20px 28px;border-top:1px solid #e6e0f5;font-family:Arial,Helvetica,sans-serif;font-size:13px;line-height:1.5;color:#585272;">
              <p style="margin:0;">Access YP Labs is a brand of Set Up Your Place LLC. The Exchange is a neutral marketplace; it is not a party to any transaction between members. Concepts are pre-proven starting points, not guarantees of income.</p>
            </td>
          </tr>
        </table>
      </td>
